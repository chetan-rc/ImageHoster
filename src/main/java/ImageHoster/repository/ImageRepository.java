...
public class ImageRepository {
    ...
    public Image getImageByTitle(Integer imageId,String title) {
        EntityManager em = emf.createEntityManager();
        try {
            TypedQuery<Image> typedQuery = em.createQuery("SELECT i from Image i where i.title =:title AND i.imageId =:imageId", Image.class).setParameter("title", title).setParameter("imageId", imageId);
